...
#SBATCH --job-name=GLMsingle_localizer_relational  
#SBATCH --partition=mit_normal
#SBATCH --output=../logs/GLMsingle_localizer_relational_%A_%a.out
#SBATCH --error=../logs/GLMsingle_localizer_relational_%A_%a.err
...
if ! python hcptrt_GLMsingle_localizer_relational.py "${TASK_ID}"; then
