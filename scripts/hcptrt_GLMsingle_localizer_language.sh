#!/bin/bash
#SBATCH --job-name=GLMsingle_localizer_language  
#SBATCH --partition=mit_normal
#SBATCH --output=../logs/GLMsingle_localizer_language_%A_%a.out
#SBATCH --error=../logs/GLMsingle_localizer_language_%A_%a.err
...
if ! python hcptrt_GLMsingle_localizer_language.py "${TASK_ID}"; then
