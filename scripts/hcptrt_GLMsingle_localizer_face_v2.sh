...
#SBATCH --job-name=GLMsingle_localizer_face_v2  
#SBATCH --partition=mit_normal
#SBATCH --output=../logs/GLMsingle_localizer_face_v2_%A_%a.out
#SBATCH --error=../logs/GLMsingle_localizer_face_v2_%A_%a.err
...
if ! python hcptrt_GLMsingle_localizer_face_v2.py "${TASK_ID}"; then
