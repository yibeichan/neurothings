...
#SBATCH --job-name=GLMsingle_localizer_social  
#SBATCH --partition=mit_normal
#SBATCH --output=../logs/GLMsingle_localizer_social_%A_%a.out
#SBATCH --error=../logs/GLMsingle_localizer_social_%A_%a.err
...
if ! python hcptrt_GLMsingle_localizer_social.py "${TASK_ID}"; then
